...
4) Authorize Repl.it to use your github  
5) Click "Start Coding Now" button  
...
7) There are two sides to the repl.it portal:  
...
8) On the file side, try typing: `puts 'Hello New Student'` and clicking "Run"    
